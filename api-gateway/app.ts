...
authenticationMiddleware: async function (req, res, next) {
  ...
  console.log("AuthenticationMiddleware Endpoint is: " + `https://appclients.auth.ap-south-1.amazoncognito.com/oauth2/userInfo`);
  try {

    let getResult = await axios.get(
      `https://appclients.auth.ap-south-1.amazoncognito.com/oauth2/userInfo`,
      {
        headers: {
   ...
   var flag=0
   request({
          url : "https://cognito-idp.ap-south-1.amazonaws.com/ap-south-1_bnKgIgmbo/.well-known/jwks.json",
          json : true
...
// app.get("/:type",[middleware.configurationMiddleware, middleware.openConfigurationMiddleware, middleware.authenticationMiddleware], async (req: any, res: any) => {
...
app.post("/:servicename/:service", async (req: any, res: any) => {
  ...
  //requestBody.token = "eyJraWQiOiJtb0FsSW9WK1crRThuMnVKcHZTMEZBR0FOZEszZGNHZE8wMW9QU0dpdDRFPSIsImFsZyI6IlJTMjU2In0..n66Aa6bQOoVpxnAgJ-UKkWH3VnaJ5vyLBSYbJRQeTFDUVpZM_a_3cxYTQB7SwlV03Bwu-Q4OTfXhP7V6qWMa1UV6D0Z4hX0vyhDEIzWttyUv41RTUb_lquTcmneiSZLtWq7DHg0PUsouIF6zvyEGEpQ3oRrGq_3mdxs1vX9ifQShfoDCrW-vXGsj4OOAzPVtTLS3lemy-BUNA7HwYoAxC_8KerTvYEnbUxQRHuuThGkInYjmOSs0cIByYbPElRbRXYcFvyS2mU4zOB3af7v3wIGJ4P0lpzADIJuva4m8EnlU6LOp1Vs32lStywsx1FwMldlf68QT1CJEthpPHAB9pA"
