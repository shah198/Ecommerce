module.exports = {
    Exchanges: [
            ...
            Subscribers: [
                {
                    ...
                    OnSuccessExchangesToPush: ["LINKS_ADDED"],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
        ...
        {
            ExchangeName: "LINKS_ADDED",
            Publishers: ["LINKS_SERVICE"],
            Method: "UNKNOWN",
            Subscribers: [
                {
                    Service: "LINKS_SERVICE",
                    ...
                    OnSuccessExchangesToPush: ["NOTIFICATION_ADDED"],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
                    QueueName: "LINKS_ADDED-LINKS_SERVICE",
                },
                {
                    Service: "API_GATEWAY_SERVICE",
                    Function: "FunctionNameToAcknowledgeUIHandle",
                    OnSuccessExchangesToPush: [],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
                    QueueName: "LINKS_ADDED-API_GATEWAY_SERVICE",
                }
            ],
        },
        {
            ExchangeName: "LINKS_UPDATE",
            Publishers: ["API_GATEWAY_SERVICE"],
            Method: "POST",
            Subscribers: [
                {
                    Service: "LINKS_SERVICE",
                    Function: "InsertLINKS",
                    OnSuccessExchangesToPush: ["LINKS_UPDATE"],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
            ...
            Subscribers: [
                {
                    ...
                    OnSuccessExchangesToPush: ["NOTIFICATION_UPDATED"],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
                    QueueName: "LINKS_UPDATED-LINKS_SERVICE",
                },
                {
                    Service: "API_GATEWAY_SERVICE",
                    Function: "FunctionNameToAcknowledgeUIHandle",
                    OnSuccessExchangesToPush: [],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
                    QueueName: "LINKS_UPDATED-API_GATEWAY_SERVICE",
                }
            ],
        },
        {
            ExchangeName: "LINKS_DELETE",
            Publishers: ["API_GATEWAY_SERVICE"],
            Method: "POST",
            Subscribers: [
                {
                    Service: "LINKS_SERVICE",
                    Function: "InsertLINKS",
                    OnSuccessExchangesToPush: ["LINKS_DELETED"],
                    OnFailureExchangesToPush: ["ERROR_RECEIVER"],
