...
EntityModule = __decorate([
    common_1.Module({
        imports: [common_1.HttpModule,
            typeorm_1.TypeOrmModule.forFeature([users_1.User, role_1.Role, product_1.Product, order_1.Order, order_item_1.OrderItem, link_1.Link]),
        ],
        providers: [linkFacade_1.LinkFacade, linkService_1.default, usersFacade_1.UsersFacade, usersService_1.default, roleFacade_1.RoleFacade, rolesService_1.default, productFacade_1.ProductFacade, productService_1.default, orderFacade_1.OrderFacade, orderService_1.default, orderItemfacade_1.OrderItemFacade, orderItemService_1.default],
        controllers: [link_route_1.LinkRoutes, users_route_1.UsersRoutes, role_route_1.RoleRoutes, product_route_1.ProductRoutes, order_route_1.OrderRoutes, orderItem_route_1.OrderItemRoutes]
    }),
