      ...
      Subscribers: [
        {
          ...
          Function: "InsertChannel",
          OnSuccessTopicsToPush: ["CART_ADDED"],
          OnFailureTopicsToPush: ["ERROR_RECEIVER"],
          QueueName: "CART_ADD-CART_SERVICE",
          QueueUrl:
            "https://sqs.us-west-2.amazonaws.com/938510084600/CHANNEL_ADD-CHANNEL_SERVICE",
          QueueArn:
            "arn:aws:sqs:us-west-2:938510084600:CHANNEL_ADD-CHANNEL_SERVICE",
      ...
      Subscribers: [
        {
          Service: "CART_SERVICE",
          Function: "InsertChannel",
          OnSuccessTopicsToPush: ["CART_UPDATED"],
          OnFailureTopicsToPush: ["ERROR_RECEIVER"],
          QueueName: "CART_UPDATE-CART_SERVICE",
          QueueUrl:
            "https://sqs.us-west-2.amazonaws.com/938510084600/CHANNEL_ADD-CHANNEL_SERVICE",
          QueueArn:
            "arn:aws:sqs:us-west-2:938510084600:CHANNEL_ADD-CHANNEL_SERVICE",
    ...
    Subscribers: [
      {
        Service: "CART_SERVICE",
        Function: "InsertChannel",
        OnSuccessTopicsToPush: ["CART_DELETED"],
        OnFailureTopicsToPush: ["ERROR_RECEIVER"],
        QueueName: "CART_DELETE-CART_SERVICE",
        QueueUrl:
          "https://sqs.us-west-2.amazonaws.com/938510084600/CHANNEL_ADD-CHANNEL_SERVICE",
        QueueArn:
          "arn:aws:sqs:us-west-2:938510084600:CHANNEL_ADD-CHANNEL_SERVICE",
